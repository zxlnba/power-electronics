...
> 🔥 **1kW 工程开发记录**见 [`工程开发文档.md`](./工程开发文档.md)；
> 60V/300W 缩尺样机的工程日志见 [`../04-60V缩尺300W/README.md`](../04-60V缩尺300W/README.md) §3。

| 文件 | 说明 |
|---|---|
| `工程开发文档.md` | 1kW 工程开发记录 |
...
| MCU | STM32G474RET6 | 12-bit ADC，170MHz，HRTIM |
...
| VCM 基线 | 1.627V（1kW 采样板 0V 慢速校零标定，实测 10 点拟合；60V 闭环固件演进为定死基线 1.628V，见 [`../04-60V缩尺300W/README.md`](../04-60V缩尺300W/README.md) §5.5） |
