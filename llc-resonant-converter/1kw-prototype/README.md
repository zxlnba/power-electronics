...
| 驱动逻辑 | 对角导通：Q1+Q4 / Q2+Q3 交替，硬件死区 ≈200ns 防桥臂直通 |
...
| 谐振电感 Lr | — | 270μH |
| 谐振电容 Cr | — | 8.2nF |
| 高频变压器 | PQ35/35 PC95 磁芯 | 原边 28T / 副边 14T+14T（中心抽头），变比 2:1 |
...
| 采样时间 | 640 周期（~60μs），平均 107kHz 开关纹波 |
| VCM 基线 | 1.645V（0V 输入时 ADC 读数） |
| 电压增益 K | 0.0066 V/V |
| 参考电压 | VDDA = 3.3V |
| 显示刷新 | 500ms |
| 平滑滤波 | 指数平滑 τ ≈ 0.3s |
