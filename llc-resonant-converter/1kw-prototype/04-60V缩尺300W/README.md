...
实际参数（Lr=8.2µH、Cr=470nF、Lm=26µH）增益曲线见 [`LLC_gain_curves_Lm26uH.png`](./LLC_gain_curves_Lm26uH.png)（`llc_rescale.m` 生成）；原设计参数曲线见 [`llc_rescale_60v300w.png`](./llc_rescale_60v300w.png)。
...
| `llc_rescale.m` | 谐振腔参数校核与增益计算（实际到手参数，生成增益曲线） |
...
| `LLC_gain_curves_Lm26uH.png` | 实测参数增益曲线（Lr=8.2µH/Cr=470nF/Lm=26µH） |
